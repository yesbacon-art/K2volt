...
export const metadata: Metadata = {
  title: 'Contact K2VOLT | Start an Energy Storage Project',
  description: 'Talk to K2VOLT about residential, commercial, industrial, or utility-scale energy storage.',
};
      ...
      <section className="page-section">
        <div className="section-shell contact-layout">
          ...
          <div className="contact-details">
            ...
            <div><span>Project inquiries</span><a href="mailto:hello@k2volt.com?subject=K2VOLT%20Energy%20Storage%20Project">Start an energy-storage project <Arrow /></a></div>
            <div><span>Applications</span><p>Residential · Commercial &amp; Industrial · Utility Scale</p></div>
